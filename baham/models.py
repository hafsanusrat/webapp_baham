...
class VehicleModel(models.Model):
    ...
    type = models.CharField(max_length=50 ,choices=[(t.name,t.value)for t  in VehicleType] , help_text="Select the vehicle chasis type")
...
class Contract (models.Model):
    ...
    fuel_share = models.PositiveSmallIntegerField(
        help_text="Percentage of fuel contribution by user")
    maintenance_share = models.PositiveSmallIntegerField(
        help_text="Percentage of maintainance contribution by user")
